 ...
 *   1. planifest-zero/ exists → this is a planifest project
...
try {
  ...
  const frameworkPath = join(cwd, "planifest-zero");
  ...
  process.stdout.write(
    "SYSTEM INSTRUCTION: This is a Planifest project (planifest-zero/ detected) " +
