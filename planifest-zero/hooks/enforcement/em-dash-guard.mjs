 ...
 * committed right now.
 *
 * Scope: plan/current/, docs/, planifest-zero/skills/,
 * planifest-zero/templates/, planifest-zero/standards/. Everything
 * else, including plan/_archive/, plan/changelog/, source code, and this
 * hook's own source and test fixtures under planifest-zero/hooks/ and
 * planifest-zero/tests/, passes without inspection: those paths simply
 ...
 * planifest-zero/standards/formatting-standards.md for the full
 * rationale.
 *
...
const SCOPED_PREFIXES = [
  "plan/current/",
  "docs/",
  "planifest-zero/skills/",
  "planifest-zero/templates/",
  "planifest-zero/standards/",
];
