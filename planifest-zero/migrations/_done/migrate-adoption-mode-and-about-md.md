...
date: "2026-05-19"
resumable: true
progress_file: "planifest-zero/migrations/_progress/migrate-adoption-mode-and-about-md.json"
---
...
A progress file at `planifest-zero/migrations/_progress/migrate-adoption-mode-and-about-md.json` tracks completion so the migration can be resumed across sessions.
...
2. If absent (or present but missing required fields), determine the best version to initialise with:
   ...
   - Read `planifest-zero/component.yml` for the framework version as a cross-reference.
...
When both parts are complete, the migrator archives this file to `planifest-zero/migrations/_done/` and deletes the progress file.
