...
```bash
mkdir -p planifest-zero/migrations/_done
mv planifest-zero/migrations/retroactive-release-tags.md \
   planifest-zero/migrations/_done/retroactive-release-tags.md
git add planifest-zero/migrations/
