...
**Scope:** `plan/`, `docs/` (planifest-zero/ prose is rewritten directly in P3)  
...
Does NOT touch `planifest-zero/` — that directory is rewritten directly during P3 codegen.
...
Move this file to `planifest-zero/migrations/_done/0002-british-english.md` when complete or explicitly skipped by the human.
