...
- **Commit messages:** Never add `Co-Authored-By` or any AI attribution. The `commit-msg` hook is **blocking**: commits with AI attribution, affirmatory language, or >72-char subjects will be rejected. Follow `planifest-zero/standards/commit-standards.md`.
