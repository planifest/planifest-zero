...
bash planifest-zero/setup.sh claude-code >/tmp/planifest_0000029_a.log 2>&1
...
bash planifest-zero/setup.sh claude-code >/tmp/planifest_0000029_b.log 2>&1
...
bash planifest-zero/setup.sh claude-code >/tmp/planifest_0000029_c.log 2>&1
