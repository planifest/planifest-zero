...
# Covers planifest-zero/scripts/self-description-check.mjs directly.
...
mkdir -p "$SCRATCH_A/planifest-zero/skills"
...
| Folder | Contents |
|--------|----------|
| [skills/](planifest-zero/skills/) | Agent instructions |
EOF
...
mkdir -p "$SCRATCH_B/planifest-zero/skills"
mkdir -p "$SCRATCH_B/planifest-zero/undocumented-folder"
...
mkdir -p "$SCRATCH_C/planifest-zero/skills"
