...
try {
    ...
    Copy-Item -Path $frameworkSrc -Destination (Join-Path $testDir "planifest-zero") -Recurse -Force
    ...
    & .\planifest-zero\setup.ps1 cursor
    ...
    & .\planifest-zero\setup.ps1 claude-code --include-full-skill-library
