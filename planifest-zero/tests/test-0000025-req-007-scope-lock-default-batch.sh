...
#
# Covers:
#   - planifest-zero/skills/planifest-orchestrator/SKILL.md Scope Lock Challenge section
#   - planifest-zero/skills/planifest-scope-lock-agent/SKILL.md Invocation Contract + description
#
# Targets planifest-zero/skills/ (the tracked, canonical source) rather
# than .claude/skills/ (a locally-installed, gitignored runtime copy synced
# from planifest-zero/skills/ by setup.sh — not committed, and not
