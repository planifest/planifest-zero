...
**Retrofit mode:** if `adoption_mode: retrofit`, follow the structured scan in `planifest-zero/workflows/retrofit.md`; the execution plan must describe the system as it exists and what is changing, not just the change in isolation.
