...
- Changing the precedence or reconciliation rules between the tracked record and the marker. ADR-002's rules carry over unchanged, only the tracked file's path moves.
